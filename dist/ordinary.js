...
var OrdinarySemaphore = /** @class */ (function (_super) {
    __extends(OrdinarySemaphore, _super);
    function OrdinarySemaphore() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    OrdinarySemaphore.prototype.genIdentityCommitment = function (identity) {
        if (!this.commitmentHasher)
            throw new Error('Hasher not set');
        var data = [circomlib.babyJub.mulPointEscalar(identity.keypair.pubKey, 8)[0], identity.identityNullifier, identity.identityTrapdoor];
        return this.commitmentHasher(data);
    };
    OrdinarySemaphore.prototype.genProofFromIdentityCommitments = function (identity, externalNullifier, signal, wasmFilePath, finalZkeyPath, identityCommitments, depth, zeroValue, leavesPerNode) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.genProofFromBuiltTree(identity, signal, merkleProof, externalNullifier, wasmFilePath, finalZkeyPath)];
                    case 1:
                        fullProof = _a.sent();
                        return [2 /*return*/, {
                                fullProof: fullProof,
    ...
    OrdinarySemaphore.prototype.genProofFromBuiltTree = function (identity, signal, merkleProof, externalNullifier, wasmFilePath, finalZkeyPath) {
        return __awaiter(this, void 0, void 0, function () {
            var signalHash, msg, signature, grothInput;
            return __generator(this, function (_a) {
                signalHash = this.genSignalHash(signal);
                msg = this.genMsg(externalNullifier, signalHash);
                signature = this.signMsg(identity.keypair.privKey, msg);
                grothInput = {
